...
const createData = card => key => {
  ...
  const text = R.cond([
    [
      R.equals("brace"),
      R.always("After the damage is totaled, the defender reduces the total to half, rounded up.")
    ],
    [
      R.equals("contain"),
      R.always("Prevent the attacker from resolving the standard critical effect.")
    ],
    [
      R.equals("evade"),
      R.always(
    ...
    [
      R.equals("redirect"),
      R.always(
        "Suffer damage on an adjacent hull zone's shields before suffering the remaining damage" +
