...
QUnit.test("findByName() Faction Galactic Empire", function(assert)
{
   // Setup.
...
QUnit.test("findByProp() Faction color red", function(assert)
{
   // Setup.
   const color = "red";
...
QUnit.test("findByProp() Faction name Galactic Empire", function(assert)
{
   // Setup.
   const name = "Galactic Empire";
...
QUnit.test("keys() Faction", function(assert)
{
   // Run.
...
QUnit.test("values() Faction", function(assert)
{
   // Run.
