...
QUnit.test('Distance properties 1', assert => {
...
QUnit.test('Distance properties 2', assert => {
...
QUnit.test('Distance properties 3', assert => {
...
QUnit.test('Distance properties 4', assert => {
...
QUnit.test('Distance properties 5', assert => {
