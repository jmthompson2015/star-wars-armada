...
QUnit.test('activeShipId()', assert => {
  // Setup.
...
QUnit.test('criticalInstancesByShip() 1', assert => {
  // Setup.
  const shipId = 1;
  const gameState = R.assocPath(
    ['shipInstances', shipId, 'criticals'],
    [1, 4],
    TestData.createGameState(),
  );
...
QUnit.test('defenseTokenInstancesByShip() 1', assert => {
  // Setup.
  const shipId = 1;
  const gameState = TestData.createGameState();
...
QUnit.test('defenseTokenInstancesBySquadron() 1', assert => {
  // Setup.
  const squadronId = 1;
  const gameState = TestData.createGameState();
...
QUnit.test('fleetInstance() 1', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const fleetId = 1;
...
QUnit.test('nextDefenseTokenId()', assert => {
  // Setup.
  const gameState = TestData.createGameState();
...
QUnit.test('shipCountByAgent() 1', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const agentId = 1;
...
QUnit.test('shipInstancesByFleet() 1', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const fleetId = 1;
...
QUnit.test('shipInstancesByFleet() 2', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const fleetId = 2;
...
QUnit.test('squadronInstancesByFleet() 1', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const fleetId = 1;
...
QUnit.test('squadronInstancesByFleet() 2', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const fleetId = 2;
...
QUnit.test('upgradeInstancesByShip() 1', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const shipId = 1;
...
QUnit.test('upgradeInstancesByShip() 2', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const shipId = 2;
...
QUnit.test('upgradeInstancesByShip() 3', assert => {
  // Setup.
  const gameState = TestData.createGameState();
  const shipId = 3;
