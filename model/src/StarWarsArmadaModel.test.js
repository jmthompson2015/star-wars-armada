...
QUnit.test('nextGameState() Command Start', assert => {
  // Setup.
  const store = TestData.createStore();
...
QUnit.test('nextGameState() Command AgentQuery 1', assert => {
  // Setup.
  const store = TestData.createStore();
...
QUnit.test('nextGameState() Command AgentQuery 2', assert => {
  // Setup.
  const store = TestData.createStore();
...
QUnit.test('nextGameState() Command', assert => {
  // Setup.
  const store = TestData.createStore();
...
QUnit.test('nextGameState() Command End', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Ship Start', assert => {
  // Setup.
  const store = TestData.createStore();
  // addPilotToManeuver(store);
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Ship End', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Squadron Start', assert => {
  // Setup.
  const store = TestData.createStore();
  // addPilotToManeuver(store);
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Squadron End', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status Start', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status Ready Defense Tokens', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status Ready Upgrade Cards', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status Ready Flip Initiative Token', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status Place Round Token', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
...
QUnit.test('nextGameState() Status End', assert => {
  // Setup.
  const store = TestData.createStore();
  store.dispatch(ActionCreator.incrementRound());
