...
const createDefenseTokenUI = (defenseInstance, isSmall, showLabel) => React.createElement(DefenseTokenUI,
{
...
const mapFunction0 = defenseInstance => prop => ReactUtilities.createCell(createDefenseTokenUI(defenseInstance, prop[0], prop[1]), prop[2], className);
...
let j = 0;
const defenseInstances = R.map(token => AS.DefenseTokenState.create(
{
   id: j++,
...
let i = 0;
const mapFunction1 = defenseInstance => ReactUtilities.createRow(createCells(defenseInstance), i++);
