...
const upgradeInstances2 = R.map(id => AS.Selector.upgradeInstance(id, gameState), shipInstance2.upgrades);
const criticalInstances2 = R.map(id => AS.Selector.criticalInstance(id, gameState), shipInstance2.criticals);
