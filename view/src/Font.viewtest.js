...
const icons = [
  "concentrate", "navigate", "repair", "squadron", // commands
  "accuracy", "crit", "hit", // dice
  "brace", "contain", "evade", "redirect", "scatter", // defense tokens
  "imperial", "rebel", // factions
  "speed", "turn-0", "turn-1", "turn-2", // maneuvers
...
icons.forEach(icon =>
{
   ...
   cells2.push(ReactUtils.createCell(ReactDOMFactories.i(
   {
      className: "ffi ffi-swa-" + icon,
   }), "icon" + cells2.length, cellClass2));
   cells2.push(ReactUtils.createCell(ReactDOMFactories.i(
   {
